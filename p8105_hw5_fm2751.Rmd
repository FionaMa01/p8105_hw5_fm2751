...
overlay_plot =
  ...
  ggplot(aes(x = mean_multi, y = estimated_mean, color = "Rejected")) +
  geom_point() +
  geom_point(data = estimates, aes(color = "Total")) +
  scale_color_manual(
    name = "Legend",
    breaks = c("Rejected", "Total"),
    values = c("Rejected" = "pink", "Total" = "blue")
  ) +
